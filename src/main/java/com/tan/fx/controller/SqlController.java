...
public class SqlController implements Initializable {
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        this.getChoiceBox().getSelectionModel().selectedItemProperty().addListener(new ChoiceChangeListener(this));
    ...
    public void format(ActionEvent actionEvent) {
        SqlController.format(this, actionEvent);
    }
     ...
     * @param actionEvent
     */
    public static void format(SqlController controller, ActionEvent actionEvent) {
    ...
    public void colorPicker(ActionEvent actionEvent) {
        String value = SqlController.toHexString(colorPicker.getValue());
     ...
     * 格式化
     */
    public static void choiceBoxChange(SqlController controller, String value) {
        if (value == null) {
        ...
        } else if (value.equals(SqlController.FieldSeparation)) {
